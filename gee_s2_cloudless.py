...
The cloud-masking functionality itself is copy-pasted but it's wrapped in a class 
which takes parameters when initialized.
...
class S2cloud_processor():
    ...
    def get_cloudfree_coll(self):
        ...
        """
        collection = self.get_s2_sr_cld_col(self.AOI, self.START_DATE, self.END_DATE)
